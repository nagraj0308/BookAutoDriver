...
class ViewHouseFragment : BaseFragment() {

    private var _binding: FragmentViewHouseBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentViewHouseBinding.inflate(inflater, container, false)
