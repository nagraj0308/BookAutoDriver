...
import com.book.homestay.databinding.FragmentHomeBinding
...
class HomeFragment : BaseFragment() {
    ...
    private fun getAuto(id: String?, list: List<Homestay>): Homestay? {
        for (au in list) {
            if (au._id == id) {
                return au
            }
    ...
    private fun showDetails(auto: Homestay) {
        val bundle = Bundle()
